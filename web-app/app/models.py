...
class SpeechModel(db.Model):
    ...
    provider = db.Column(db.String(50), nullable=False)  # whisper_local, openai, azure
...
class TextModel(db.Model):
    ...
    name = db.Column(db.String(100), nullable=False)
    display_name = db.Column(db.String(100), nullable=False)
    provider = db.Column(db.String(50), nullable=False)  # ollama, openai, azure
    endpoint_url = db.Column(db.String(500))
    api_key = db.Column(db.String(500))
    model_id = db.Column(db.String(100))
    azure_deployment = db.Column(db.String(100))
...
class Job(db.Model):
    ...
    job_type = db.Column(db.String(30), nullable=False)  # transcription, meeting, dictation, text_tool
